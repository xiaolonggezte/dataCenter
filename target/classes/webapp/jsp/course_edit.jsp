...
<div class="demoTable">
    ...
    <div class="layui-inline">
        <input class="layui-input" id="course_edit_courseNumber" autocomplete="off">
    </div>
    搜索周次：
    <div class="layui-inline">
        <input class="layui-input" id="course_edit_courseWeek" autocomplete="off">
    </div>
    搜索实验室：
    <div class="layui-inline">
        <input class="layui-input" id="course_edit_coursePlace" autocomplete="off">
    </div>
    <button id="course_edit_search" class="layui-btn" data-type="reload">搜索</button>
</div>
<table class="layui-hide" id="demo_course_edit" lay-filter="course_edit_filter"></table>
