...
<div class="layui-upload" align="center">
    ...
    <button type="button" class="layui-btn layui-btn-normal" id="select_file_course_input">选择文件</button>
    <button type="button" class="layui-btn" id="upload_file_course_input">开始上传</button>
    <hr/>
    <hr/>
    <hr/>
</div>
